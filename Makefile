...
COMPONENTS := base zookeeper kafka kafka-rest schema-registry kafka-connect-base kafka-connect control-center kafkacat enterprise-replicator enterprise-kafka
