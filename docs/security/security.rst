...
For details on available security features in Confluent platform, please refer to the `Confluent Platform Security Overview Documentation <http://docs.confluent.io/3.1.2/kafka/security.html>`_.

For a tutorial on using SSL in the Confluent Platform please refer to the documented tutorials on `SSL <http://docs.confluent.io/3.1.2/kafka/ssl.html>`_ and `SASL <http://docs.confluent.io/3.1.2/kafka/sasl.html>`_.
