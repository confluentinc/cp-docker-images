...
8. Now, we will replicate another topic from a different source cluster.
  ...
  Now lets ``exec`` into the Kafka Connect container and run the replicator connector. Enter the following commands on your terminal. You should see output simialar to step 6 above.
