...
- A working Docker environment (Docker for Mac is not recommended - see below)
- An understanding of how Docker host networks and bridge networks work (Highly Recommended)
